        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <h4 class="text-center"><a href="mailto:vic.estrada@protonmail.com">vic.estrada@protonmail.com</a></h4>
              <h4 class="text-center"><a href="https://twitter.com/Vic_techcomm">Twitter</a></h4>
              <br/>
            </div>
